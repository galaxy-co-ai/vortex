...
export function AlertPanel() {
  ...
  const { event, headline, description, instruction, onset, expires, senderName, areaDesc } =
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "glass-panel fixed overflow-hidden flex flex-col",
          "transition-transform duration-[var(--duration-normal)] ease-[var(--ease-decelerate)]",
          // Desktop: right slide-over
          "md:top-12 md:right-0 md:bottom-0 md:w-[400px] md:rounded-none md:border-l",
          // Mobile: bottom sheet
          "max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:max-h-[75vh] max-md:rounded-t-xl"
        )}
